...
public class Initializer extends Base {
	...
	// @before = when we add the @Before hooks on top of our beforeHooks method ,
	// this method will
	...
	// @after = When we add the @After annotation on top of our afterHools method,
	// this method will
	// run after every scenario
	// In this method, we can also write the code to add a screenshot of our failed
	// test step, if it fails
	@After
